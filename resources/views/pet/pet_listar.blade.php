...
@section('content')
    <div class="titulo-pagina">
        <div>
            <h2 class="mb-4">Listagem de Pets</h2>
        </div>
        <div class="itens-titulo-pagina">
            ...
            <div class="btn-group " role="group" style="margin-right: 10px; width: 200px;">
                ...
                <li><a class="dropdown-item" href="/funcionario">Novo Pet</a></li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <tr>
                    ...
                    <td class="colum_options">
                        <span style="margin-right: 5px;" >
                            <a type="button" class="btn btn-primary" href="/pet?i=1">
                                <span class="bi bi-brush"></span> 
                            </a>
                        </span>
                        <span class="btn_remover_registro" id="1">
    ...
    @else
        <div id="infongMessage" class="alert alert-info alert-block" style="text-align:center"> 
            <strong>Não existem Pets a serem listados</strong>
        </div>
    @endif
...
<script>
    $( document ).ready(function() {
        ...
        $(".btn_remover_registro").on("click",function(){
            showModalRemove('Atenção!', 'Deseja realmente remover este Pet?', "Remover", "Cancelar", () => {
